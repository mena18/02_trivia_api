...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_name = settings.TEST_DATABASE_NAME
        self.database_username = settings.TEST_DATABASE_USERNAME
        self.database_password = settings.TEST_DATABASE_PASSWORD
    ...
    def test_delete_question_exists(self):
        delete_id = 2  # must be changed after each test if you aren't going to drop the database
